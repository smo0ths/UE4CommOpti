...
fx.EarlyScheduleAsync=0; 🟡 def 0
fx.EnableCircularAnimTrailDump=0; ⚪️ EDITED 🟡 def 2
fx.Niagara.QualityLevel=2; 🟢 0 for PERFORMANCE 🔵 0,1,2,3,4 low,med,high,ultra,cine
...
r.AllowOcclusionQueries=1; 🟡 def 1 🔵 hardware occlusion culling
...
r.DBuffer=1; 🟡 def 1 🔵 decal material blend modes
...
r.DownsampledOcclusionQueries=0; 🟡 def 0
...
r.LumenScene.SurfaceCache.NaniteLODScaleFactor=1; 🟡 def 1
...
r.NormalMapsForStaticLighting=0; 🟡 def 0
...
r.Shadow.NaniteLODBias=1; 🟡 def 1
...
r.Streaming.HLODStrategy=0; 🟡 def 0
...
rhi.SyncSlackMS=10; 🟡 def 10 🔵 sync
s.MaxIncomingRequestsToStall=100; 🟡 def 100
s.MaxReadyRequestsToStallMB=30; 🟡 def 30
