...
*Updated 12/10/2019 ~ lot of changes i'll have to test more later 
...
r.LightShaftFirstPassDistance=0.05 ;
r.BloomQuality=3 ;
...
bSmoothFrameRate=0
bUseVSync=0 
FrameRateLimit=111.000000 ; set what you want or lower to reduce GPU usage for NVENC 
FrameLimit=111 ; set what you want or lower to reduce GPU usage for NVENC 
