...
r.GenerateMeshDistanceFields=0; 0 for SANDSTORM
r.AllowStaticLighting=1; 1 for SANDSTORM
...
r.ViewDistanceScale.FieldOfViewAffectsHLOD=1; 1 for SANDSTORM
r.SkeletalMeshLODRadiusScale=1;
r.StaticMeshLODDistanceScale=1;
r.HLOD=1; 1 for SANDSTORM
