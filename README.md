...
[ConsoleVariables]
sg.EffectsQuality=3;---------------🟢 0 for PERFORMANCE
sg.FoliageQuality=3;---------------🟢 0 for PERFORMANCE
sg.PostProcessQuality=3;---------------🟢 0 for PERFORMANCE
...
r.MinScreenRadiusForCSMDepth=0.01;
r.MinScreenRadiusForDepthPrepass=0.03;
r.MinScreenRadiusForLights=0.03;---------------🟢 0.04,0.06 for PERFORMANCE
r.MipMapLODBias=0;
r.MotionBlurQuality=0;---------------🔵 EDITED
r.MSAACount=0;---------------🔵 EDITED
r.NGX.DLAA.Enable=0;---------------🟢 0 for PERFORMANCE
