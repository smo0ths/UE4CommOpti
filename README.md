#### updated 1/14/2023 ✂️ 📋 :ramen: v0.9.9.1 release
...
r.Upscale.Quality=0;---------------🟢 0,1 for PERFORMANCE 🔵 EDITED
...
r.DOF.Kernel.MaxForegroundRadius=0.006;
r.DOF.Kernel.MaxBackgroundRadius=0.006;
r.BloomQuality=1;---------------🟢 0 for PERFORMANCE 🔵 EDITED
r.Filter.SizeScale=0.5;---------------🔵 EDITED
...
r.SkyAtmosphere.MultiScatteringLUT.HighQuality=1;---------------🟢 0 for PERFORMANCE
...
r.VolumetricFog.GridPixelSize=4;---------------🔵 EDITED
...
r.AmbientOcclusionLevels=2;---------------🟢 0 for PERFORMANCE 🔵 EDITED
...
D3D12.TexturePoolOnlyAccountStreamableTexture=1;---------------🔵 EDITED
...
r.Streaming.MaxNumTexturesToStreamPerFrame=12;---------------🟢 1 for PERFORMANCE 🔵 EDITED 🔵 req AmortizeCPUToGPUCopy
r.Streaming.FramesForFullUpdate=12;---------------🔵 EDITED
r.Streaming.NumStaticComponentsProcessedPerFrame=12;---------------🔵 EDITED
