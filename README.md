...
r.DepthOfFieldQuality=1;------def 2------1 or 0 for PERFORMANCE
...
r.Shadow.CSM.TransitionScale=1.5;------def 0.8------changed to 1.5*
r.Shadow.CSMDepthBias=13;------def 10------changed to 13*
r.Shadow.DistanceScale=1.5;------def 0.85------changed to 1.5------0.85 for PERFORMANCE
...
r.Shadow.PointLightDepthBias=0.007;------def 0.02------changed to 0.007*
r.Shadow.PointLightSlopeScaleDepthBias=5;------def 3------changed to 5*
r.Shadow.RadiusThreshold=0.03;------def 0.04------0.03 for PERFORMANCE
r.Shadow.SpotLightTransitionScale=256;------def 60------changed to 256*
