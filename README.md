...
r.MipMapLODBias=0;------def 0------2 for PERFORMANCE
...
r.ParticleLODBias=1;------def 0------changed
...
r.Shadow.CSM.MaxCascades=2;------def 3------1 or 2 for PERFORMANCE------changed
...
r.Shadow.MaxResolution=2048;------def 2048------1024 for PERFORMANCE------changed
...
r.Streaming.MipBias=1;------def 0------1 for PERFORMANCE------changed
